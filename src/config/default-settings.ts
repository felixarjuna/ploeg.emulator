...
import { ChargePointInfo, ConnectionInfo, SimulationInfo, StationInfo } from "../common/contracts";
import stationSettings from "./station-config";

const defaultSettings: {
  mainSettings: ConnectionInfo;
  bootNotification: ChargePointInfo;
  stationSettings: StationInfo;
